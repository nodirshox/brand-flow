...
export default function SignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Map frontend role to API enum
      const apiRole = role === "brand" ? UserRole.BUSINESS : UserRole.CREATOR;
          ...
          <div className="mt-6 sm:mt-8">
            {step === 1 ? (
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2.5 sm:gap-3">
                    <button
                      ...
                      className="px-3 sm:px-4 py-2.5 sm:py-3 text-sm font-medium rounded-lg transition-all bg-zinc-50 text-zinc-600 hover:bg-zinc-100 hover:text-zinc-900 dark:bg-zinc-900/50 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:text-white"
                    >
                      Business
                    </button>
                    <button
              ...
              <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
                ...
                <div className="flex items-center justify-between p-2.5 sm:p-3 bg-zinc-50 dark:bg-zinc-800/50 rounded-lg">
                  <div>
                    <p className="text-xs text-zinc-500 dark:text-zinc-400">
                      Role
                    </p>
                    <p className="text-sm font-medium text-zinc-900 dark:text-white">
                      {role === "brand" ? "Business" : "Influencer"}
                    </p>
                  </div>
                  <button
                    type="button"
